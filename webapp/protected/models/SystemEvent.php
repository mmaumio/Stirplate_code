 ...
 *
 * The followings are the available columns in table 'system_event':
 * @property integer $id
...
class SystemEvent extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, type, description, userId, created, modified', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return SystemEvent the static model class
	 */
